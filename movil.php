...
<script>
    (function() {
        ...
        // Opcional: recargar cuando cambie la orientación
        window.addEventListener('resize', function() {
            setTimeout(() => {
                const deviceInfo = getDeviceInfo();
                const iframe = document.getElementById('appIframe');
                const currentUrl = new URL(iframe.src);
                currentUrl.searchParams.set('ancho', deviceInfo.screenWidth);
                currentUrl.searchParams.set('alto', deviceInfo.screenHeight);
