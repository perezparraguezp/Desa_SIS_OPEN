<div class="container">
    ...
    $sql1 = "select * from historial_parametros_ad 
                ...
                <div class="col l1">
                    ...
                    if($persona->myID==$row1['id_profesional']){
                        ...
                        <i class="mdi-action-delete red-text"
                           onclick="deleteHistorial('historial_parametros_ad','<?php echo $row1['id_historial']; ?>')"
            ...
            if(confirm('DESEA ELIMINAR ESTE REGISTRO')){
                $.post('db/delete/historial.php',{
                    ...
                    if(data!=='ERROR_SQL'){
                        ...
                        loadHistorialParametroAD('<?php echo $rut ?>','<?php echo $indicador ?>')
                    }
                });
            }
        }
