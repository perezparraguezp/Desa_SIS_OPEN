...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var cellLinkRegistroTarjetero = function(row, columnfield, value, defaulthtml, columnproperties, rowdata) {
            return '<i onclick="menuEhOpen_ADOLESCENTE(\'menu_1\',\'registro_atencion\',\''+value+'\')" class="mdi-hardware-keyboard-return"></i> IR' ;
        }
        ...
        var cellSexo = function(row, columnfield, value, defaulthtml, columnproperties, rowdata) {
            if(value=='M'){
                ...
                return  "pink lighten-1 ehite-text";
            }
        ...
        $("#excelExport").click(function () {
            ...
            $("#grid").jqxGrid('exportdata', 'xls', 'Pacientes SIS Adolescentes', true,null,true, 'https://carahue.eh-open.com/exportar/save-file.php');
