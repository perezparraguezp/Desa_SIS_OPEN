...
$sql = "select * from tipo_consejerias_adolescente 
            where id_tipo_consejeria='$atributo' 
            limit 1";
$row = mysql_fetch_array(mysql_query($sql));


$TITULO_GRAFICO = strtoupper(str_replace("_"," ",$row['nombre_consejeria']));
...
if($comunal==true){
    ...
    while ($row_0 = mysql_fetch_array($res_0)){
        ...
        $sql_1 = "select * from consejerias_adolescente inner join tipo_consejerias_adolescente using(id_tipo_consejeria)
                    where trim(rut)=trim('$persona->rut')
                    and estado_consejeria='SI' ";
        ...
        while($row_1 = mysql_fetch_array($res_1)){
            ...
            $indicador_json = $row_1['id_tipo_consejeria'];
            ...
            $indicador_json = $row_1['nombre_consejeria'];
            $nombre_grafico = $indicador_json;
...
?>
    <script type="text/javascript">
        ...
        function loadGrafico_AD_filtro() {
    ...
    <div id="div_imprimir">
        ...
        <div class="card-panel">
            <div class="row">
                <div class="col l2">
                    <select name="edad" onchange="loadGrafico_AD_filtro()" id="edad">
