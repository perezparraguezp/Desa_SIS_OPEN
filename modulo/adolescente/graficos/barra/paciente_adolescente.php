...
if($comunal==true){
    ...
    while ($row_0 = mysql_fetch_array($res_0)){
        ...
        $sql_1 = "select * from paciente_adolescente where trim(rut)=trim('$persona->rut') limit 1";
        $row_1 = mysql_fetch_array(mysql_query($sql_1));
        if($row_1){
            $sql_2 = "select * from historial_parametros_ad 
                                          where trim(rut)=trim('$persona->rut') and indicador='$indicador'
    ...
    if($establecimientos==true){
        ...
        while($row1 = mysql_fetch_array($res1)){
            ...
            while ($row_0 = mysql_fetch_array($res_0)){
                ...
                $sql_1 = "select * from paciente_adolescente where rut='$persona->rut' limit 1";
                $row_1 = mysql_fetch_array(mysql_query($sql_1));
                if($row_1){
                    $sql_2 = "select * from historial_parametros_ad 
