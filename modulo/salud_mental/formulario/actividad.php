            ...
            <div class="card-panel eh-open_fondo">
                <div class="row">
                    <div class="col l8 m8 s8">
                        <strong style="line-height: 2em;font-size: 1.5em;">HISTORIAL DE ACTIVIDADES <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="EL REGISTRO SERÁ GUARDADO AUTOMATICAMENTE">(?)</strong></strong>
                    </div>
                    <div class="col l4 m4 s4">
                        <div class="btn blue" onclick="boxNewActividad()"> + AGREGAR ACTIVIDAD </div>
                    </div>
                </div>
                <hr class="row" />
                <div class="row">
                    <div class="col l2 s2 m2">FECHA INGRESO</div>
                    <div class="col l8 s8 m8">TIPO ACTIVIDAD</div>
                    <div class="col l2 s2 m2">FECHA EGRESO</div>
                </div>
                <hr class="row" />
                <?php
                $sql1 = "SELECT * FROM paciente_actividad_sm
                            where rut='$rut'  
                            order by id desc";
                ...
                while($row1 = mysql_fetch_array($res1)){
                    ...
                    <div class="row rowInfoSis" >
                        <div class="col l2 s4 m2"><?PHP echo fechaNormal($row1['fecha_registro']).' 
                                <strong class="tooltipped" data-position="bottom" data-delay="50" data-tooltip="OBS INGRESO: '.$row1['obs_ingreso'].'">(?)</strong>'; ?></div>
                        <div class="col l8 s8 m8"><?PHP echo $row1['nombre_actividad']; ?></div>
                        <div class="col l2 s2 m2">
                            <?PHP

                            if($row1['fecha_registro']==$fecha_registro){
                                ?>
...
<script type="text/javascript">
    ...
    function boxNewActividad(){
        $.post('formulario/new_actividad.php',{
            rut:'<?php echo $rut ?>',
