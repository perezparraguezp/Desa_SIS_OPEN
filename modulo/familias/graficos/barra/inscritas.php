...
if($comunal==true){
    ...
    while ($row_0 = mysql_fetch_array($res_0)){
        ...
        $json .= '{"IR":"'.$familia->id_familia.'","CODIGO":"'.$familia->codigo_familia.'","NOMBRE":"'.$familia->nombre.'","COMUNAL":"'.$familia->nombre_sector_comunal.'","ESTABLECIMIENTO":"'.$familia->nombre_centro.'","SECTOR_INTERNO":"'.$familia->nombre_establecimiento.'"}';
