...
where nombre_sector_comunal='RURAL' order by nombre_sector_interno";
...
<section id="seccion_A1" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l12">
            <header>SECCION A1: CLASIFICACIÓN DE LAS FAMILIAS SECTOR RURAL
            </header>
        </div>
    </div>
    <div class="row">
        <div class="col l12">
            <table id="table_seccion_a1" style="width: 70%;border: solid 1px black;" border="1">
