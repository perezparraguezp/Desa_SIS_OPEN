    ...
    <div class="row">
        <div class="col l4 m6 s12">
            ...
            <select name="indicador" id="indicador">
                ...
                <option value="inscritas">FAMILIAS INSCRITAS</option>
                <option value="riesgo">FAMILIAS POR RIESGO</option>
                <option value="riesgo_vigencia">FAMILIAS POR RIESGO VIGENCIA</option>
                <option value="vdi">VDI VIGENCIA</option>
                <option value="trazadores">TRAZADORES</option>
