            ...
            <div class="nav-wrapper">
                <div class="col s12">
                    ...
                    <ul class="right hide-on-med-and-down">
                        <li onclick="load_estadistica_REMP7()"><a href="#"><i class="mdi-action-assignment-turned-in left"></i>REM P7</a></li>
...
<script type="text/javascript">
    load_estadistica_REMP7();

    function load_estadistica_REMP7() {
