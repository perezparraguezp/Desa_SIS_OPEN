                        ...
                        <div class="row">
                            ...
                            <div class="col l7 m6 s12">
                                <div class="row">
                                    ...
                                    <div class="col l3 m3 s3 tooltipped" data-position="bottom" data-delay="50" data-tooltip="BAJO PESO">
                                    ...
                                    <div class="col l3 m3 s3 tooltipped" data-position="bottom" data-delay="50" data-tooltip="NORMAL">
                                        <div class="row center-align">
                                    ...
                                    <div class="col l3 m3 s3 tooltipped" data-position="bottom" data-delay="50" data-tooltip="SOBRE PESO">
                                        <div class="row center-align">
                                    ...
                                    <div class="col l3 m3 s3 tooltipped" data-position="bottom" data-delay="50" data-tooltip="OBESIDAD">
                                        <div class="row center-align">
...
<script type="text/javascript">
    ...
    function loadHistorialParametroPSCV(rut,indicador) {
        $.post('grid/historial_parametros_pscv.php',{
            rut:rut,
            indicador:indicador
        },function(data){
            if(data !== 'ERROR_SQL'){
    ...
    function updateParametroPSCV_EKG() {
        var fecha = $("#fecha_ekg").val();
        $.post('db/update/pscv_parametros.php',{
            column:'ekg',
            value:fecha,
            fecha_registro:fecha,
    ...
    function updateParametroPSCV_IMC(value) {
