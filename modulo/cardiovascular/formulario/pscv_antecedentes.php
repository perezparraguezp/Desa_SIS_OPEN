...
$patologia_hta_hearts =  $paciente->getIndicadorPSCV('patologia_hta_hearts');
...
$tratamiento_clo       =  $paciente->getIndicadorPSCV('tratamiento_clo');
                        ...
                        <div class="row">
                            ...
                            <div class="col l9 m6 s12">
                                <div class="row">
                                    ...
                                    <div class="col l4 m12 s12">
                                        <input type="checkbox" id="patologia_hta_hearts"
                                               onchange="updateIndicadorPSCV('patologia_hta_hearts')"
                                            <?php echo $patologia_hta_hearts=='SI'?'checked="checked"':'' ?>
                                               name="patologia_hta_hearts"  />
                                        <label class="white-text" for="patologia_hta_hearts">HEARTS</label>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col l4 m12 s12">
                        ...
                        <div class="row">
                            ...
                            <div class="col l9 m6 s12">
                                <div class="row">
                                    ...
                                    <div class="col l6 m12 s12">
                                        <input type="checkbox" id="tratamiento_clo"
                                               onchange="updateIndicadorPSCV('tratamiento_clo')"
                                            <?php echo $tratamiento_clo=='SI'?'checked="checked"':'' ?>
                                               name="tratamiento_clo"  />
                                        <label class="white-text" for="tratamiento_clo">CLOPIDOGREL</label>
                                    </div>
                                    <div class="col l6 m12 s12">
