...
if($comunal==true){
    ...
    while($row2 = mysql_fetch_array($res2)){
        ...
        $json .= '{ "IR":"'.$persona->rut.'", "RUT":"'.$persona->rut.'","NOMBRE":"'.$persona->nombre.'","EDAD":"'.$persona->edad.'","COMUNAL":"'.$row2['nombre_sector_comunal'].'","ESTABLECIMIENTO":"'.$row2['nombre_centro_interno'].'","SECTOR_INTERNO":"'.$row2['nombre_sector_interno'].'","INDICADOR":"'.$row2[$atributo].'","ATRIBUTO":"'.$indicador.'","CONTACTO":"'.$persona->getContacto().'","HEARTS":"'.$row2['patologia_hta_hearts'].'"}';
        $total_pacientes++;
    }
        ...
        $("#table_grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'HEARTS', dataField: 'HEARTS', cellsalign: 'left', width: 250,filtertype: 'checkedlist' },
