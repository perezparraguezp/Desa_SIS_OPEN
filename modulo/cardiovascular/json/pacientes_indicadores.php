...
$filtro = '';
if($id_sector_interno!='TODOS'){
    $filtro = "and paciente_establecimiento.id_sector='$id_sector_interno' ";
}
$filtro = '';
    ...
    if($paciente->existe==true){
        if($paciente->nombre!=''){
            ...
            if($row1['fondo_ojo_fecha']==''){
                ...
                $fondo_ojo_fecha = $row1['hba1c_fecha'];
            }
            ...
            if(strtoupper($paciente->nombre_sector_comunal)!=''){
                $customers[] = array(
                    ...
                    'dlp' => $dlp,
                    'hba1c' => $hba1c,
                    'hba1c_fecha' => $hba1c_fecha,
                    'ev_pie' => limpiaCadena($ev_pie),
                    'ev_pie_fecha' => fechaNormal($ev_pie_fecha),
                    'fondo_ojo' => limpiaCadena($fondo_ojo),
