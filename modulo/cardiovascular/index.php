...
<!--    <script type="text/javascript" src="../../js/plugins/chartist-js/chartist.min.js"></script>-->
    ...
    <script type="text/javascript">
        ...
        function loadMenu_CardioVascular(menu,php,rut) {
            var div = 'content';
            $("#"+div).hide();
            $.post('menu/'+php+'.php',{
                rut:rut
...
<div id="main">
    ...
    <div class="wrapper">
        ...
        <!-- //////////////////////////////////////////////////////////////////////////// -->
        <section id="loading_seccion">
            <div class="center">
                <div class="card-panel">
                    <img src="http://sis.eh-open.com/loding.gif" width="300" />
    ...
    <div class="footer-copyright grey lighten-2 black-text">
        <div class="container">
            ...
            <a class="light-blue-text" href="http://www.eh-open.com" style="text-decoration: none">
                <img src="https://sis.eh-open.com/ehopen_logo.png" alt="materialize logo" height="64" />
            </a>
        </span>
        </div>
    </div>
