...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var settings1 = {
            ...
            description: "DESDE LOS 3 AÑOS",
            enableAnimations: true,
            showLegend: true,
            padding: { left: 1, top: 1, right: 1, bottom: 5 },
            titlePadding: { left: 91, top: 1, right: 1, bottom: 10 },
            source: sampleData,
            xAxis:
                {
                    dataField: 'Rango',
        ...
        $("#excelExport").click(function () {
            ...
            $("#table_grid").jqxGrid('exportdata', 'xls', 'PA', true, null, true, 'https://imperial.sis-open.com/exportar/save-file.php');
        });
    });
</script>
