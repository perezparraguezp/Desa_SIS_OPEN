...
<div class="col l12 s12 m12">
    <div class="card-panel eh-open_fondo">
        <div class="row">
            <div class="col l3">
                <span class="black-text letra_datos_nacimiento">PKU <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="PESO EDAD">(?)</strong></span>
            </div>
            <div class="col l8">
...
<div class="col l12 s12 m12">
    <div class="card-panel eh-open_fondo">
        <div class="row">
            <div class="col l3">
                <span class="black-text letra_datos_nacimiento">HC <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="PESO EDAD">(?)</strong></span>
            </div>
            <div class="col l8">
...
<div class="col l12 s12 m12">
    <div class="card-panel eh-open_fondo">
        <div class="row">
            <div class="col l3">
                <span class="black-text letra_datos_nacimiento">APEGO INMEDIATO <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="PESO EDAD">(?)</strong></span>
            </div>
            <div class="col l8">
...
<div class="col l12 s12 m12">
    <div class="card-panel eh-open_fondo">
        <div class="row">
            <div class="col l3">
                <span class="black-text letra_datos_nacimiento">VACUNA BCG <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="PESO EDAD">(?)</strong></span>
            </div>
            <div class="col l8">
...
<div class="col l12 s12 m12">
    <div class="card-panel eh-open_fondo">
        <div class="row">
            <div class="col l3">
                <span class="black-text letra_datos_nacimiento">VACUNA HEPATITIS B <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="INDICAR SI EL PACIENTE RECIBIO LA VACUNA DE HEPATITIS B">(?)</strong></span>
            </div>
            <div class="col l8">
