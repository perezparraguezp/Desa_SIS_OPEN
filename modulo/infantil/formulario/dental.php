                    ...
                    <div class="col l12">
                        <div class="settings-section">
                            <div class="settings-label">
                                <span class="black-text">CERO <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="PARA NIÑOS DESDE LOS 8 MESES">(?)</strong></span>
                            </div>
            ...
            <div class="card-panel eh-open_fondo">
                <div class="row">
                    <div class="col l12">
                        <div class="settings-section">
                            <div class="settings-label">
                                <span class="black-text">GES 6 <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="PARA NIÑOS DESDE LOS 6 AÑOS 1 MES EN ADELANTE">(?)</strong></span>
                            </div>
                            <div class="settings-setter">
    ...
    if(1==6){
        ...
        <div class="col l12 s12 m12">
            <div class="card-panel eh-open_fondo">
                <div class="row">
                    <div class="col l3">
                        <span class="black-text">C <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="C">(?)</strong></span>
                    </div>
                    <div class="col l8">
                ...
                <div class="row">
                    <div class="col l3">
                        <span class="black-text">E <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="E">(?)</strong></span>
                    </div>
                    <div class="col l8">
                ...
                <div class="row">
                    <div class="col l3">
                        <span class="black-text">O <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="O">(?)</strong></span>
                    </div>
                    <div class="col l8">
