        ...
        if($paciente->validaDNI()){
            ...
            <div class="col l12 s12 m12">
                <div class="card-panel eh-open_fondo">
                    <div class="row">
                        <div class="col l4">
                            <span class="black-text letra_datos_psicomotor">RX PELVIS <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="RADIOGRAFIA DE PELVIS">(?)</strong></span>
                        </div>
                        <div class="col l8">
        ...
        if($paciente->total_meses < 24){
            ...
            <div class="col l12 s12 m12">
                <div class="card-panel eh-open_fondo">
                    <div class="row">
                        <div class="col l4">
                            <span class="black-text letra_datos_psicomotor">PAUTA BREVE <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="">(?)</strong></span>
                        </div>
                        <div class="col l8">
                        ...
                        <script type="text/javascript">
                            $(function(){
                                ...
                                $('#lenguaje').on('change',function(){
                                    $.post('db/update/lenguaje_eedp.php',{
                                        val:$('#lenguaje').val(),
                                        rut:'<?php echo $rut; ?>',
                                        fecha_registro:'<?php echo $fecha_registro; ?>'
                                ...
                                $('#motrocidad').on('change',function(){
                                    $.post('db/update/motrocidad_eedp.php',{
                                        val:$('#motrocidad').val(),
                                        rut:'<?php echo $rut; ?>',
                                        fecha_registro:'<?php echo $fecha_registro; ?>'
                                ...
                                $('#coordinacion').on('change',function(){
                                    $.post('db/update/coordinacion_eedp.php',{
                                ...
                                $('#social').on('change',function(){
                                    $.post('db/update/social_eedp.php',{
                                        val:$('#social').val(),
                                        rut:'<?php echo $rut; ?>',
                                        fecha_registro:'<?php echo $fecha_registro; ?>'
                            ...
                            <script type="text/javascript">
                                $(function(){
                                    ...
                                    $('#lenguaje_tepsi').on('change',function(){
                                        $.post('db/update/lenguaje_tepsi.php',{
                                    ...
                                    $('#motrocidad_tepsi').on('change',function(){
                                        $.post('db/update/motrocidad_tepsi.php',{
                                    ...
                                    $('#coordinacion_tepsi').on('change',function(){
                                        $.post('db/update/coordinacion_tepsi.php',{
