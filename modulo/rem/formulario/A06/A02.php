    ...
    <div class="row">
        ...
        <div class="col l7">
            <div class="container" id="info_evaluacion">
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>CONSULTORÍAS DE SALUD MENTAL</option>
                            <option>TELECONSULTORÍAS DE SALUD MENTAL</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
                ...
                <div class="row">
                    <div class="col l4">CONSULTORÍAS Y TELECONSULTORÍAS RECIBIDAS</div>
                    <div class="col l8">
                        <select name="tipo_consultaria" id="tipo_consultaria">
                            <option>CONSULTORÍAS Y TELECONSULTORÍAS DE SALUD MENTAL INFANTO ADOLESCENTE</option>
                            <option>CONSULTORÍAS Y TELECONSULTORÍAS DE SALUD MENTAL ADULTO</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
