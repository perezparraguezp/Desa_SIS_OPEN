    ...
    <div class="row">
        ...
        <div class="col l7">
            <div class="container" id="info_evaluacion">
                <div class="row">
                    <div class="col l4">PLAN</div>
                    <div class="col l8">
                        <select name="tipo_plan" id="tipo_plan">
                            <option>PLAN AMBULATORIO BÁSICO</option>
                            <option>PLAN AMBULATORIO INTENSIVO</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
                                $('#tipo_plan').jqxDropDownList({
                                    width: '100%',
                                    theme: 'eh-open',
                                    height: '25px'
                                });
