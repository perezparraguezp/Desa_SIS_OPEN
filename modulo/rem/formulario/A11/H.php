                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>Gestantes estudiadas para EGB en APS </option>
                            <option>Gestantes estudiadas en APS con examen EGB (+) </option>
                            <option>Gestantes estudiadas para EGB en Especialidades </option>
                            <option>Gestantes estudiadas en Especialidades con examen EGB (+)  </option>
                            <option>Gestantes estudiadas para EGB en nivel hospitalario </option>
                            <option>Gestantes estudiadas en nivel hospitalario con examen EGB (+)  </option>
                            <option>Gestantes con profilaxis para  EGB (+) al parto  </option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
