                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>Gestantes con 1° test no treponémico reactivo en este embarazo con  penicilina administrada en Atención Primaria</option>
                            <option>Gestantes con 1° test no treponémico reactivo </option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
