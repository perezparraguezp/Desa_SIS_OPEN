                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>Recién nacidos hijos de madre Hepatitis B positiva, nacidos en el periodo </option>
                            <option>Recién nacidos hijos de madre Hepatitis B positiva que recibieron profilaxis completa, según la normativa vigente </option>
