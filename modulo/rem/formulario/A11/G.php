                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>Recién nacidos vivos hijos de mujer VIH (+) confirmada por ISP que recibieron leche maternizada al alta (para ser consumida en su casa) </option>
                            <option>Recién nacidos vivos hijos de mujer VIH (+) confirmada por ISP</option>
                            <option>Recien nacidos vivos hijos de mujer con serología VIH (+) no confirmada por el ISP  que recibieron leche maternizada al alta (para ser consumida en su casa) </option>
                            <option>Recien nacidos vivos hijos de mujer con serología VIH (+) no confirmada por el ISP </option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
