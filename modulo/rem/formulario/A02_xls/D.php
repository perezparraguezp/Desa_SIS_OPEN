...
$FILA_HEAD = [
    'GLICEMIA ALTERADA (= > a 100 mg/dl)',
    'COLESTEROL ELEVADO (= > 200 mg/dl)',
];
$FILA_HEAD_SQL = [
    "valor like '%estado_salud%:%GLICEMIA%'",
    "valor like '%estado_salud%:%COLESTEROL%'",
];
...
<section id="seccion_A02D" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN D: RESULTADOS DE EMP SEGÚN ESTADO DE SALUD (EXÁMENES DE LABORATORIO) [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
