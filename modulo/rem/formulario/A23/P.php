    ...
    <div class="row">
        ...
        <div class="col l7">
            <div class="container" id="info_evaluacion">
                ...
                <div class="row">
                    <div class="col l4">ENCUESTAS REALIZADAS</div>
                    <div class="col l8">
                        <select name="tipo_encuestas" id="tipo_encuestas">
                            <option>INGRESO</option>
                            <option>REEVALUACIÓN ANUAL</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
                                $('#tipo_encuestas').jqxDropDownList({
                                    width: '100%',
                                    theme: 'eh-open',
                                    height: '25px'
                                });
