                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>HOGAR LIBRE DEL HUMO DEL TABACO</option>
                            <option>POR MUERTE DE NEUMONÍA EN DOMICILIO</option>
                            <option>PROGRAMA OXIGENOTERAPIA AMBULATORIA, AVNI, AVI, AVNIA, AVIA </option>
                            <option>SEGUIMIENTO TELEFÓNICO REALIZADO POR KINESIOLOGO SALA </option>
                            <option>OTRAS VISITAS </option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
