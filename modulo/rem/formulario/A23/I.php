                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>ESPIROMETRÍA BASAL </option>
                            <option>ESPIROMETRÍA POST BD</option>
                            <option>FLUJOMETRÍA BASAL </option>
                            <option>FLUJOMETRÍA POST BD</option>
                            <option>PIMOMETRÍA</option>
                            <option>TEST DE PROVOCACIÓN CON EJERCICIO</option>
                            <option>TEST DE MARCHA 6 MINUTOS</option>
                            <option>SESIONES DE KINESIOTERAPIA RESPIRATORIA</option>
                            <option>TOMA DE MUESTRA SECRECIÓN MUCOSA/BRONQUIAL</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
