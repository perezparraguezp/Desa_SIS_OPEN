        ...
        <div class="col l7">
            <div class="container" id="info_evaluacion">
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            ...
                            <option>Contacto individual  por mensaje en redes sociales</option>
                            <option>Contacto grupal por mensaje en redes sociales </option>
                        </select>
                        <script type="text/javascript">
                            $(function () {
                ...
                <div class="row">
                    <div class="col l12">
                        <div class="settings-section">
                            <div class="settings-label">GRUPAL</div>
                            <div class="settings-setter">
                                <div id="grupal"></div>
                                <input type="hidden" name="input_grupal" id="input_grupal" value="NO"/>
                            </div>
                        </div>
                        <script type="text/javascript">
                            $(function () {
                                $('#grupal').jqxSwitchButton({
                                    height: 27, width: 81,
                                    theme: 'eh-open',
                                    onLabel: 'SI',
                                    offLabel: 'NO',
                                });
                                $('#grupal').on('change', function () {
                                    if ($('#grupal').val() === true) {
                                        $("#input_grupal").val('SI');
                                    } else {
                                        $("#input_grupal").val('NO');
                ...
                <div class="row">
                    <div class="col l12">
                        <div class="settings-section">
                            <div class="settings-label">BENFICIARIO</div>
                            <div class="settings-setter">
