...
<aside id="left-sidebar-nav">
    <ul id="slide-out" class="side-nav fixed leftside-navigation">
        ...
        <li id="menu_1" onclick="loadMenu_REM('menu_1','registro_touch','')"class="bold"><a href="#" class="waves-effect waves-cyan"><i class="mdi-maps-pin-drop"></i> REGISTRO PACIENTE</a>
            <ul>
                <li>REM A01 - AAA</li>
            </ul>
        </li>
