...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"HOGAR LIBRE DEL HUMO DEL TABACO"%\'',
    'valor like \'%"tipo_atencion":"POR MUERTE DE NEUMONÍA EN DOMICILIO"%\'',
    'valor like \'%"tipo_atencion":"PROGRAMA OXIGENOTERAPIA AMBULATORIA, AVNI, AVI, AVNIA, AVIA"%\'',
    'valor like \'%"tipo_atencion":"SEGUIMIENTO TELEFÓNICO REALIZADO POR KINESIOLOGO SALA"%\'',
    'valor like \'%"tipo_atencion":"OTRAS VISITAS"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN N: VISITAS DOMICILIARIAS Y SEGUIMIENTO REALIZADOS POR EQUIPO IRA-ERA  [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
