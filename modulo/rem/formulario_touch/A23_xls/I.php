...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"ESPIROMETRÍA BASAL"%\'',
    'valor like \'%"tipo_atencion":"ESPIROMETRÍA POST BD"%\'',
    'valor like \'%"tipo_atencion":"FLUJOMETRÍA BASAL"%\'',
    'valor like \'%"tipo_atencion":"FLUJOMETRÍA POST BD"%\'',
    'valor like \'%"tipo_atencion":"PIMOMETRÍA"%\'',
    'valor like \'%"tipo_atencion":"TEST DE PROVOCACIÓN CON EJERCICIO"%\'',
    'valor like \'%"tipo_atencion":"TEST DE MARCHA 6 MINUTOS"%\'',
    'valor like \'%"tipo_atencion":"SESIONES DE KINESIOTERAPIA RESPIRATORIA"%\'',
    'valor like \'%"tipo_atencion":"TOMA DE MUESTRA SECRECIÓN MUCOSA/BRONQUIAL"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN I: PROCEDIMIENTOS REALIZADOS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
