...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"SÍNDROME BRONQUIAL OBSTRUCTIVA RECURRENTE (SBOR)"%\'',
    ...
    'valor like \'%"tipo_atencion":"OXÍGENO DEPENDIENTE"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCION C: EGRESOS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
