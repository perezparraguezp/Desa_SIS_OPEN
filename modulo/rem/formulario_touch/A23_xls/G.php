...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"S.B.O. RECURRENTE"%\'',
    'valor like \'%"tipo_atencion":"S.B.O. DISPLASIA BRONCOPULMONAR"%\'',
    'valor like \'%"tipo_atencion":"S.B.O. FIBROSIS QUÍSTICA"%\'',
    'valor like \'%"tipo_atencion":"S.B.O. ASMA"%\'',
    'valor like \'%"tipo_atencion":"S.B.O. ENFERMEDAD PULMONAR OBSTRUCTIVA CRÓNICA EPOC"%\'',
    'valor like \'%"tipo_atencion":"S.B.O. OTRAS RESPIRATORIAS CRÓNICAS"%\'',
    'valor like \'%"tipo_atencion":"S.B.O. TOTAL"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN G: INASISTENTES A CONTROL DE CRÓNICOS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
