...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"AUTOCUIDADO SEGÚN PATOLOGÍA"%\'',
    'valor like \'%"tipo_atencion":"USO DE TERAPIA INHALATORIA"%\'',
    'valor like \'%"tipo_atencion":"EDUCACION INTEGRAL EN SALUD RESPIRATORIA"%\'',
    'valor like \'%"tipo_atencion":"ESTILO DE VIDA SALUDABLES"%\'',
    ...
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN M: EDUCACIÓN EN SALAS
                <BR />SECCIÓN M.1: EDUCACION INDIVIDUAL EN SALA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
