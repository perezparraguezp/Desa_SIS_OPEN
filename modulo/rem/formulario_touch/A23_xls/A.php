...
$rango_seccion = [
    "registro_rem.edad like 'MENOS 1 AÑO'",
    ...
    'valor like \'%"Reingresos":"SI"%\'',
    'valor like \'%"Campaña de Invierno":"SI"%\'',
...
$FILA_HEAD = [
    ...
    'OTRAS IRAS  BAJAS',
    'EXACERBACIÓN SÍNDROME BRONQUIAL OBSTRUCTIVO RECURRENTE (SBOR)',
    'EXACERBACIÓN ASMA',
...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"I.R.A. ALTA"%\'',
    'valor like \'%"tipo_atencion":"INFLUENZA"%\'',
    'valor like \'%"tipo_atencion":"NEUMONÍA"%\'',
    'valor like \'%"tipo_atencion":"COQUELUCHE"%\'',
    'valor like \'%"tipo_atencion":"BRONQUITIS OBSTRUCTIVA AGUDA"%\'',
    'valor like \'%"tipo_atencion":"OTRAS IRAS  BAJAS"%\'',
    'valor like \'%"tipo_atencion":"EXACERBACIÓN SÍNDROME BRONQUIAL OBSTRUCTIVO RECURRENTE (SBOR)"%\'',
    'valor like \'%"tipo_atencion":"EXACERBACIÓN ASMA"%\'',
    'valor like \'%"tipo_atencion":"EXACERBACIÓN DE ENFERMEDAD PULMONAR OBSTRUCTIVA CRÓNICA (EPOC)"%\'',
    'valor like \'%"tipo_atencion":"EXACERBACIÓN FIBROSIS QUÍSTICA"%\'',
    'valor like \'%"tipo_atencion":"EXACERBACIÓN OTRAS RESPIRATORIAS CRÓNICAS"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN A: INGRESOS AGUDOS SEGÚN DIAGNOSTICO [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
