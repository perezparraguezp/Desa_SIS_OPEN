...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"UNIDAD EMERGENCIA HOSPITALARIA"%\'',
    'valor like \'%"tipo_atencion":"SAPU, SUR O SAR"%\'',
    'valor like \'%"tipo_atencion":"CAE / CDT / CRS"%\'',
    'valor like \'%"tipo_atencion":"EXTRASISTEMA"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN K: RECEPCIÓN DE PACIENTES SEGÚN ORIGEN [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
