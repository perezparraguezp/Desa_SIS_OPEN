...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"INGRESOS AL PROGRAMA"%\'',
    'valor like \'%"tipo_atencion":"TOTAL EGRESOS"%\'',
    'valor like \'%"tipo_atencion":"INASISTENTES"%\'',
];
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN T: INGRESOS Y EGRESOS POR COMERCIO SEXUAL (Uso exclusivo de Unidades Control Comercio Sexual)[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
