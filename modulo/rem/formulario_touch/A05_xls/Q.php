...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_programa":"PROGRAMA DE REHABILITACIÓN TIPO I"%\'',
    'valor like \'%"tipo_programa":"PROGRAMA DE REHABILITACIÓN TIPO II"%\'',
...
$FILTRO_PROFESION[0] = [
    'valor like \'%"tipo_programa":"PROGRAMA DE REHABILITACIÓN TIPO I"%\' AND valor like \'%"INGRESOS"%\'',
    'valor like \'%"tipo_programa":"PROGRAMA DE REHABILITACIÓN TIPO I"%\' AND valor like \'%"EGRESOS"%\'',
...
$FILTRO_PROFESION[1] = [
    'valor like \'%"tipo_programa":"PROGRAMA DE REHABILITACIÓN TIPO II"%\' AND valor like \'%"INGRESOS"%\'',
    'valor like \'%"tipo_programa":"PROGRAMA DE REHABILITACIÓN TIPO II"%\' AND valor like \'%"EGRESOS"%\'',
];
