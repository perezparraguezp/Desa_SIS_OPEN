...
$rango_seccion = [
    ...
    "registro_rem.edad like '50 y MAS'",
    'valor like \'%"Victima de violencia de genero":"SI"%\'',
    "pueblo='SI' ",
    "migrante='SI' ",
    'valor like \'%"Ingresos por Traslado":"SI"%\'',
...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"GESTANTES INGRESADAS"%\'',
    'valor like \'%"tipo_ronda":"PRIMIGESTAS INGRESADAS"%\'',
    'valor like \'%"tipo_ronda":"GESTANTES INGRESADAS ANTES DE LAS 14 SEMANAS"%\'',
    'valor like \'%"tipo_ronda":"GESTANTES CON EMBARAZO NO PLANIFICADO"%\'',
];
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN A:  INGRESOS DE GESTANTES A PROGRAMA PRENATAL [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
