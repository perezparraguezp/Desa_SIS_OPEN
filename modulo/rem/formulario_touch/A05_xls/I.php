...
$rango_seccion = [
    ...
    "registro_rem.valor like '%lactancia%:%Abandono%'",
    "registro_rem.valor like '%lactancia%:%Traslado%'",
    "registro_rem.valor like '%lactancia%:%Fallecimiento%'",
    "registro_rem.valor like '%lactancia%:%No cumple criterio%'",
...
<section id="seccion_A03C" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN I: EGRESOS  DEL PSCV[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_C" style="width: 100%;border: solid 1px black;" border="1">
        ...
        echo '<tr><td rowspan="10">PROGRAMA DE SALUD CARDIOVASCULAR</td>';
        $FILA_HEAD = [
        ...
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_atencion":"HIPERTENSIÓN ARTERIAL"%\'',
            'valor like \'%"tipo_atencion":"DIABETES MELLITUS"%\'',
            'valor like \'%"tipo_atencion":"DISLIPIDEMIA"%\'',
            'valor like \'%"tipo_atencion":"ANTECEDENTES ENF. CARDIOVASCULAR ATEROSCLERÓTICA"%\'',
