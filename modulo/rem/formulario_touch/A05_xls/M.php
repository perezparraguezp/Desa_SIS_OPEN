...
$rango_seccion = [
    "registro_rem.edad like '69 A 64'",
...
<section id="seccion_A03C" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN M: INGRESOS Y EGRESOS DEL  PROGRAMA MÁS ADULTOS MAYORES AUTOVALENTES [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_C" style="width: 100%;border: solid 1px black;" border="1">
        ...
        echo '<tr><td rowspan="3" >INGRESO</td>';
        $FILA_HEAD = [
        ...
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_condicion":"AUTOVALENTE SIN RIESGO"%\'',
            'valor like \'%"tipo_condicion":"AUTOVALENTE CON RIESGO"%\'',
            'valor like \'%"tipo_condicion":"TOTAL INGRESOS"%\'',
        ...
        echo '<tr><td rowspan="4" >EGRESO</td>';
        $FILA_HEAD = [
            'COMPLETA CICLO',
            'ABANDONO',
            'TRASLADO ',
        ...
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_condicion":"COMPLETA CICLO"%\'',
            'valor like \'%"tipo_condicion":"ABANDONO"%\'',
            'valor like \'%"tipo_condicion":"TRASLADO"%\'',
            'valor like \'%"tipo_condicion":"FALLECIMIENTO"%\'',
