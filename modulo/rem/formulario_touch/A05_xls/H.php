...
<section id="seccion_A03C" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN H: INGRESOS AL PSCV [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_C" style="width: 100%;border: solid 1px black;" border="1">
        ...
        echo '<tr><td COLSPAN="2" >INGRESOS AL PSCV</td>';
        $FILA_HEAD = [
             ""
        ];
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_atencion":"INGRESOS AL PSCV"%\'',
