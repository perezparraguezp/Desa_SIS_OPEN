...
$rango_seccion = [
    "registro_rem.edad like 'MENOR DE 20'",
    ...
    "registro_rem.valor like '%tipo_egreso%:%Altas%'",
    "registro_rem.valor like '%tipo_egreso%:%Abandono/Traslado%'",
    "registro_rem.valor like '%tipo_egreso%:%Fallecimiento%'",
...
<section id="seccion_A03C" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN J: INGRESOS Y EGRESOS AL PROGRAMA DE PACIENTES CON DEPENDENCIA LEVE, MODERADA Y SEVERA[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_C" style="width: 100%;border: solid 1px black;" border="1">
        ...
        <?php
        echo '<tr><td COLSPAN="2" >DEPENDENCIA MODERADA</td>';
        $FILA_HEAD = [
            ""
        ];
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_atencion":"DEPENDENCIA MODERADA"%\'',
        ...
        echo '<tr><td COLSPAN="2" >EGRESOS DEL PSCV</td>';
        $FILA_HEAD = [
            ""
        ];
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_atencion":"EGRESOS DEL PSCV"%\'',
        ...
        echo '<tr><td rowspan="2" >DEPENDENCIA GRAVE Y TOTAL</td>';
        $FILA_HEAD = [
            "ONCOLÓGICO",
            "NO ONCOLÓGICO",
        ];
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_atencion":"DEPENDENCIA GRAVE Y TOTAL"%\'',
        ...
        echo '<tr><td rowspan="2">DEPENDENCIA SEVERA CON  ESCARAS </td>';
        $FILA_HEAD = [
            '',
        ];
        $FILA_HEAD_SQL = [
            'valor like \'%"tipo_atencion":"DEPENDENCIA SEVERA CON  ESCARAS "%\'',
