...
$rango_seccion = [
    ...
    "registro_rem.edad like '%MENORES DE 1 AÑO'",
    "registro_rem.edad like '%NIÑOS 12 A 23 MESES'",
    "registro_rem.edad like '%MENOR 2%'",
...
$FILA_HEAD = [
    'CIRCULO DE ACTIVIDAD FÍSICA',
    'CIRCULO DE VIDA SANA',
    'ACTIVIDADES MASIVAS',

];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"CIRCULO DE ACTIVIDAD FÍSICA"%\'',
    'valor like \'%"tipo_atencion":"CIRCULO DE VIDA SANA"%\'',
    'valor like \'%"tipo_atencion":"ACTIVIDADES MASIVAS"%\'',
];
...
<section id="seccion_A03A2" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN F: TALLERES PROGRAMA ELIGE VIDA SANA[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A2" style="width: 100%;border: solid 1px black;" border="1">
        ...
        <tr>
            ...
            foreach ($rango_seccion_text as $i => $item){
                echo '<td colspan="1" rowspan="2">'.$item.'</td>';
            }
            ?>
        </tr>
        <?php
