...
$FILA_HEAD_SQL = [
    'valor like \'%"Taller Nadie es Perfecto (PASMI)"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN H: PERSONAS QUE INGRESAN A TALLERES PARA PADRES DEL PROGRAMA DE APOYO A LA SALUD MENTAL INFANTIL (PASMI) [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td  rowspan="2">
                Total de Padres, Madres o Cuidadores de 5 a 9 años
            </td>
