...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"ESPACIOS COMUNITARIOS"%\'',
    'valor like \'%"tipo_atencion":"ESTABLECIMIENTOS EDUCACIONALES"%\'',
    'valor like \'%"tipo_atencion":"CENTROS DE SALUD"%\'',
...
<section id="seccion_A02A" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN B: ACTIVIDADES DE PROMOCIÓN
                <BR />SECCIÓN B.4: TALLERES GRUPALES SEGÚN TEMÁTICA Y NUMERO DE PARTICIPANTES EN PROGRAMA ESPACIOS AMIGABLES  [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td colspan="1"ROWSPAN="1">
                AMBIENTE LIBRE DE HUMO DEL TABACO
            </td>
            <td colspan="1"ROWSPAN="1">
                FACTORES PROTECTORES PSICOSOCIALES
            </td>
            <td colspan="1"ROWSPAN="1">
                PREVENCIÓN CONSUMO DE ALCOHOL Y OTRAS DROGAS
            </td>
            <td colspan="1"ROWSPAN="1">
