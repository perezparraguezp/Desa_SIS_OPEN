...
$FILA_HEAD = [
    'TRATAMIENTO DE SIFILIS EN GESTANTES EN ATENCIÓN PRIMARIA',
    'Gestantes con 1° test no treponémico reactivo en este embarazo con  penicilina administrada en Atención Primaria',
    'Gestantes con 1° test no treponémico reactivo',


];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"TRATAMIENTO DE SIFILIS EN GESTANTES EN ATENCIÓN PRIMARIA"%\'',
    'valor like \'%"tipo_atencion":"Gestantes con 1° test no treponémico reactivo en este embarazo con  penicilina administrada en Atención Primaria"%\'',
    'valor like \'%"tipo_atencion":"Gestantes con 1° test no treponémico reactivo"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCION A: TRATAMIENTO DE SIFILIS EN GESTANTES [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
