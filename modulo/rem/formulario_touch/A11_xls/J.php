...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Recién nacidos hijos de madre Hepatitis B positiva, nacidos en el periodo"%\'',
    'valor like \'%"tipo_atencion":"Recién nacidos hijos de madre Hepatitis B positiva que recibieron profilaxis completa, según la normativa vigente"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCION J: PROFILAXIS DE TRANSMISIÓN VERTICAL APLICADA AL RECIEN NACIDO, HIJO DE MADRE HEPATITIS B POSITIVA[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
