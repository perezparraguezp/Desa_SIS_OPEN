...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"NIVEL PRIMARIO"%\'',
    'valor like \'%"tipo_atencion":"ATENCIÓN MORBILIDAD"%\'',
    'valor like \'%"tipo_atencion":"ATENCIÓN TRATAMIENTO"%\'',
    'valor like \'%"tipo_atencion":"ATENCIÓN URGENCIA"%\'',
];
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN K : GESTIÓN DE AGENDA (CLÍNICAS DENTALES MÓVILES). CLINICAS MOVILES [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
