...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":" HORARIO CONTINUADO"%\'',
...
$FILTRO_PROFESION[0] = [
    'valor like \'%"tipo_atencion":"HORARIO CONTINUADO"%\' AND  valor like \'%"tipo_horario":"VESPERTINA (LUNES-VIERNES)"%\'',
    'valor like \'%"tipo_atencion":"HORARIO CONTINUADO"%\' AND  valor like \'%"tipo_horario":"SÁBADO, DOMINGO o FESTIVO"%\'',
...
<section id="seccion_A03A2" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN E: CONSULTAS ODONTOLÓGICAS  EN HORARIO CONTINUADO [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
