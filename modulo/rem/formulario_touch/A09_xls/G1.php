...
$rango_seccion = [
    ...
    'valor like \'%"JUNJI":"SI"%\'',
    'valor like \'%"INTEGRA":"SI"%\'',
    'valor like \'%"MINEDUC":"SI"%\'',
...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"EXAMEN DE SALUD"%\'',
    'valor like \'%"tipo_atencion":"Nº DE NIÑOS CON ÍNDICE ceod=0 AL INGRESO"%\'',
    'valor like \'%"tipo_atencion":"SET DE HIGIENE ORAL ENTREGADOS"%\'',
    'valor like \'%"tipo_atencion":"Nº DE APLICACIONES FLÚOR BARNIZ"%\'',
    'valor like \'%"tipo_atencion":"EDUCACIÓN GRUPAL EN ESTABLECIMIENTO DE EDUCACIÓN"%\'',
    'valor like \'%"tipo_atencion":"N° DE ESTABLECIMIENTOS DE EDUCACIÓN CON PROGRAMA IMPLEMENTADO"%\'',
