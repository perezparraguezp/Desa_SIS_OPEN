...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"PULIDO CORONARIO Y DESTARTRAJE SUPRAGINGIVAL"%\'',
    'valor like \'%"tipo_atencion":"FLUORURACIÓN TÓPICA"%\'',
    'valor like \'%"tipo_atencion":"EDUCACIÓN INDIVIDUAL CON INSTRUCCIÓN DE TÉCNICA DE CEPILLADO"%\'',
    'valor like \'%"tipo_atencion":"RADIOGRAFÍAS INTRAORALES (RETROALVEOLARES Y BITEWING)"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN J: ACTIVIDADES EFECTUADAS POR TÉCNICO PARAMÉDICO DENTAL Y/O HIGIENISTAS DENTALES [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td ROWSPAN="3">
                60 años (incluidos en grupos de 20-64 años)
            </td>
