                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>CONSULTA DE ALERTA</option>
                            <option>CONTROL DE SEGUIMIENTO</option>
                            <option>CONSEJERÍA EN LACTANCIA MATERNA</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="edad" id="edad">
                            <option>0 A 29 DIAS </option>
                            <option>1 A 2 MESES 29 DIAS</option>
                            <option>3 A 5 MESES 29 DIAS</option>
