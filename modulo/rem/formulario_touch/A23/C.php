                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>SÍNDROME BRONQUIAL OBSTRUCTIVA RECURRENTE (SBOR)</option>
                            <option>ASMA BRONQUIAL</option>
                            <option>ENFERMEDAD PULMONAR OBSTRUCTIVA CRÓNICA (EPOC) </option>
                            <option>DISPLASIA BRONCOPULMONAR</option>
                            <option>FIBROSIS QUÍSTICA</option>
                            <option>OXÍGENO DEPENDIENTE</option>
                            <option>ASISTENCIA VENTILATORIA NO INVASIVA O INVASIVA </option>
                            <option>OTRAS RESPIRATORIAS CRÓNICAS</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
