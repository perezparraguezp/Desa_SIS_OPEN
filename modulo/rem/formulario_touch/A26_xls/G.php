...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"ESTABLECIMIENTO EDUCACIONAL"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN G: VISITA A ESTABLECIMIENTO EDUCACIONAL PROGRAMA DE APOYO A LA SALUD MENTAL INFANTIL (PASMI) EN ATENCIÓN PRIMARIA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td colspan="1" rowspan="2">
                TOTAL VISITAS 5 A 9 AÑOS
            </td>
            <td colspan="1" rowspan="2">
                NÚMERO DE NIÑOS/AS VISITADOS 5 A 9 AÑOS
            </td>
