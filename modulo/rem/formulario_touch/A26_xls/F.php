...
$FILA_HEAD = [
    'ACCIONES TELEFÓNICAS REALIZADAS (LLAMADAS O MENSAJERÍA)',

];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"ACCIONES TELEFÓNICAS REALIZADAS (LLAMADAS O MENSAJERÍA)"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN F: APOYO TELEFÓNICO DEL PROGRAMA DE ACOMPAÑAMIENTO PSICOSOCIAL EN APS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td colspan="5" rowspan="1">
                NÚMERO DE OTRAS VISITAS SEGÚN RANGO ETARIO
            </td>
