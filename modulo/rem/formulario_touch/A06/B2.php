    ...
    <div class="row">
        <div class="col l12">
            <div class="container" id="info_evaluacion">
                <div class="row">
                    <div class="col l4">PROGRAMA</div>
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>PROGRAMA DE REHABILITACIÓN TIPO I</option>
                            <option>PROGRAMA DE REHABILITACIÓN TIPO II</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
                ...
                <div class="row">
                    ...
                    <div class="col l8">
                        <select name="tipo_diaspersona" id="tipo_diaspersona">
                            <option>DÍAS PERSONA</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
                                $('#tipo_diaspersona').jqxDropDownList({
                                    width: '100%',
                                    theme: 'eh-open',
                                    height: '25px'
                                });
