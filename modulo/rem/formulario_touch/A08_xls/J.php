...
$rango_seccion = [
    'valor like \'%"TOTAL LLAMADAS":"SI"%\'',
    'valor like \'%"LLAMADAS VALIDAS":"SI"%\'',
...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"CENTRO REGULADOR"%\'',
];
$PROFESIONES[0] = [
    'Nº LLAMADOS DE URGENCIA',

];
$FILTRO_PROFESION[0] = [
    'valor like \'%"tipo_atencion":"CENTRO REGULADOR"%\' AND  valor like \'%"tipo_llamadas":"Nº LLAMADOS DE URGENCIA"%\'',
];
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN J: LLAMADOS DE URGENCIA A CENTRO REGULADOR [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td rowspan="2">TOTAL DE LLAMADAS</td>
            <td rowspan="2">LLAMADAS VALIDAS</td>
