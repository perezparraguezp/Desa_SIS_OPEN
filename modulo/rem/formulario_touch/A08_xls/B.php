...
$FILA_HEAD_SQL = [
    /* REVISAR*/
    'valor like \'%"tipo_atencion":"C1"%\'',
    'valor like \'%"tipo_atencion":"C2"%\'',
    'valor like \'%"tipo_atencion":"C3"%\'',
    'valor like \'%"tipo_atencion":"C4"%\'',
    'valor like \'%"tipo_atencion":"C5"%\'',
    'valor like \'%"tipo_atencion":"SIN CATEGORIZACIÓN"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN B: CATEGORIZACIÓN DE PACIENTES, PREVIA A LA ATENCIÓN MÉDICA (Establecimientos Alta, Mediana o Baja Complejidad y SAR). [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
