...
$FILA_HEAD_SQL = [
    /* REVISAR*/
    'valor like \'%"tipo_atencion":"VIOLENCIA INTRAFAMILIAR (VIF)"%\'',
    'valor like \'%"tipo_atencion":"OTRAS VIOLENCIAS"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN G: ATENCIONES MÉDICAS ASOCIADAS A  VIOLENCIA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
