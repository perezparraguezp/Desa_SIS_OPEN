...
$rango_seccion = [
    ...
    'valor like \'%"ANTICONCEPCION":"SI"%\'',
    'valor like \'%"VIH":"SI"%\'',
    'valor like \'%"ITS":"SI"%\'',
    'valor like \'%"hepatitisb":"SI"%\'',
    'valor like \'%"tipo_victimario":"VICTIMARIO"%\'',
...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"VIOLENCIA SEXUAL"%\'',
];
$PROFESIONES[0] = [
    '72 horas o menos',
    'después de 72 horas',
...
$FILTRO_PROFESION[0] = [
    'valor like \'%"tipo_atencion":"VIOLENCIA SEXUAL"%\' AND  valor like \'%"tipo_hora":"72 horas o menos"%\'',
    'valor like \'%"tipo_atencion":"VIOLENCIA SEXUAL"%\' AND  valor like \'%"tipo_hora":"después de 72 horas"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN O: ATENCIONES  EN URGENCIA POR VIOLENCIA SEXUAL [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
