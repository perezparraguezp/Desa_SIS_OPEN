...
$FILA_HEAD = [
    'ATENCIÓN POR ANTICONCEPCIÓN DE EMERGENCIA',


];
$FILA_HEAD_SQL = [

    'valor like \'%"tipo_atencion":"ATENCIÓN POR ANTICONCEPCIÓN DE EMERGENCIA"%\'',
];
$PROFESIONES[0] = [
    'ATENCIÓN POR ANTICONCEPCIÓN DE EMERGENCIA',
    'SIN ENTREGA DE ANTICONCEPTIVO',

];
$FILTRO_PROFESION[0] = [
    'valor like \'%"tipo_atencion":"ATENCIÓN POR ANTICONCEPCIÓN DE EMERGENCIA"%\' AND  valor like \'%"tipo_anticonceptivo":"ATENCIÓN POR ANTICONCEPCIÓN DE EMERGENCIA"%\'',
    'valor like \'%"tipo_atencion":"ATENCIÓN POR ANTICONCEPCIÓN DE EMERGENCIA"%\' AND  valor like \'%"tipo_anticonceptivo":"SIN ENTREGA DE ANTICONCEPTIVO"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN H: ATENCIONES  POR ANTICONCEPCIÓN DE EMERGENCIA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
