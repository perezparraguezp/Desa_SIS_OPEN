...
$FILA_HEAD = [
    'PACIENTES FALLECIDOS EN ESPERA DE ATENCIÓN MÉDICA',
    'PACIENTES FALLECIDOS EN PROCESO DE ATENCIÓN',
    'PACIENTES FALLECIDOS EN ESPERA DE CAMA HOSPITALARIA',

];
$FILA_HEAD_SQL = [

    'valor like \'%"tipo_atencion":"PACIENTES FALLECIDOS EN ESPERA DE ATENCIÓN MÉDICA"%\'',
    'valor like \'%"tipo_atencion":"PACIENTES FALLECIDOS EN PROCESO DE ATENCIÓN"%\'',
    'valor like \'%"tipo_atencion":"PACIENTES FALLECIDOS EN ESPERA DE CAMA HOSPITALARIA"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN F: PACIENTES FALLECIDOS EN UEH (Establecimientos Alta, Mediana o Baja Complejidad, SAR, SAPU y SUR)  [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
