...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN A.4: ATENCIONES DE URGENCIA REALIZADAS EN ESTABLECIMIENTOS  ATENCIÓN PRIMARIA NO SAPU (APS NO SAPU) [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
