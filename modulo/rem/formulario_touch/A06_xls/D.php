...
$FILA_HEAD = [
    'PLAN DE ACOMPAÑAMIENTO ELABORADOS',
    'EVALUACIONES PARTICIPATIVAS REALIZADAS AL EGRESO DEL PROGRAMA',


];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"PLAN DE ACOMPAÑAMIENTO ELABORADOS"%\'',
    'valor like \'%"tipo_atencion":"EVALUACIONES PARTICIPATIVAS REALIZADAS AL EGRESO DEL PROGRAMA"%\'',
];
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN D: PLANES Y EVALUACIONES PROGRAMA DE ACOMPAÑAMIENTO PSICOSOCIAL EN ATENCIÓN PRIMARIA[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
