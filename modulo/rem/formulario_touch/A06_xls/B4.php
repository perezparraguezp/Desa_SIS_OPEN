...
$FILA_HEAD = [
    ...
    'HOSPITAL PSIQUIÁTRICO DIURNO',
    'CENTRO PRIVATIVO DE LIBERTAD (SENAME)',
];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"HOGAR PROTEGIDO"%\'',
    'valor like \'%"tipo_atencion":"RESIDENCIA PROTEGIDA"%\'',
    'valor like \'%"tipo_atencion":"HOSPITAL PSIQUIÁTRICO DIURNO"%\'',
    'valor like \'%"tipo_atencion":"CENTRO PRIVATIVO DE LIBERTAD (SENAME)"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN B.4: DISPOSITIVOS DE SALUD MENTAL[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td colspan="2">
                DÍAS DE ESTADA DE PERSONAS ATENDIDAS EN EL MES
            </td>
            <td COLSPAN="2">
                Nº DE EGRESOS
            </td>
