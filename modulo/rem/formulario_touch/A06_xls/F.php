...
$FILA_HEAD = [
    'N° DE EVALUACIONES DIAGNÓSTICAS',



];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"N° DE EVALUACIONES DIAGNÓSTICAS"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN F: PERSONAS CON EVALUACIÓN Y CONFIRMACIÓN DIAGNOSTICA EN APS[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
