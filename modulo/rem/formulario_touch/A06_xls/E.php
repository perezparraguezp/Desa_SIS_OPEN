...
$FILA_HEAD = [
    'PLAN DE CUIDADO INTEGRAL (PCI) ELABORADOS',



];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"PLAN DE CUIDADO INTEGRAL (PCI) ELABORADOS"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN E: PLANES DE CUIDADO INTEGRAL (PCI)[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
