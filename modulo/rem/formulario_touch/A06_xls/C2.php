...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"DE FAMILIA"%\'',
    'valor like \'%"tipo_atencion":"PENALES"%\'',
    'valor like \'%"tipo_atencion":"CIVILES"%\'',
    'valor like \'%"tipo_atencion":"POLICÍA LOCAL"%\'',
    'valor like \'%"tipo_atencion":"LABORALES"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN C.2: INFORMES A TRIBUNALES[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
