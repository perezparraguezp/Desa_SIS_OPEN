...
$FILTRO_PROFESION[0] = [
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%MÉDICO%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%PSICÓLOGO/A%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%ENFERMERA /O%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%MATRONA /ÓN%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%ASISTENTE SOCIAL%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%OTROS PROFESIONALES%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%TERAPEUTA OCUPACIONAL%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%TÉCNICO PARAMÉDICO y EN SALUD MENTAL%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%GESTOR COMUNITARIO%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%TÉCNICO REHABILITACIÓN ALCOHOL Y DROGAS%\'',
    'valor like \'%"sub_seccion":"PRIMERA AYUDA PSICOLÓGICA"%\' AND  profesion like \'%TOTAL%\'',
];
$PROFESIONES[1] = [
    '',
