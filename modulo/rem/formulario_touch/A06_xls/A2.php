...
$FILA_HEAD = [
    ...
    'TELECONSULTORÍAS DE SALUD MENTAL',
    'TOTAL',

];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"CONSULTORÍAS DE SALUD MENTAL"%\'',
    'valor like \'%"tipo_atencion":"TELECONSULTORÍAS DE SALUD MENTAL"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN A.2: CONSULTORÍAS DE SALUD MENTAL EN APS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        <tr>
            ...
            <td  rowspan="3"  >
                TOTAL CONSULTORÍAS Y TELECONSULTORÍAS RECIBIDAS
            </td>
            <td colspan="2" rowspan="2">
                CONSULTORÍAS Y TELECONSULTORÍAS RECIBIDAS
            </td>
            <td colspan="3" rowspan="2">
                TOTAL Nº DE CASOS REVISADOS
            </td>
            <td colspan="34" >
                POR EDAD
            </td>
        ...
        <tr>
            <td>CONSULTORÍAS Y TELECONSULTORÍAS DE SALUD MENTAL INFANTO ADOLESCENTE</td>
            <td>CONSULTORÍAS Y TELECONSULTORÍAS DE SALUD MENTAL ADULTO</td>
            <td>AMBOS</td>
            <td>HOMBRE</td>
            <td>MUJER</td>
            <?php
