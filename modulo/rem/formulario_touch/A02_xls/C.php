...
$FILA_HEAD = [
    'TABAQUISMO',
    'PRESION ARTERIAL ELEVADA (>= 140/90 mmHg)',
];
$FILA_HEAD_SQL = [
    "valor like '%estado_salud%:%TABAQUI%'",
    "valor like '%estado_salud%:%PRESION%'",
];
...
<section id="seccion_A02C" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN C: RESULTADOS DE EMP SEGÚN ESTADO DE SALUD[<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
