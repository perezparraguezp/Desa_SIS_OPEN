...
$FILA_HEAD = [
    'Muestras procesadas para diagnostico de tuberculosis pulmonar mediante bacteriologia',
];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"MUESTRAS PROCESADAS PARA DIAGNOSTICO DE TUBERCULOSIS PULMONAR MEDIANTE BACTERIOLOGIA"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN O:  EXÁMENES BACTERIOLOGICOS PROCESADOS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
