...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"MAL NUTRICIÓN POR DÉFICIT"%\'',
    'valor like \'%"tipo_atencion":"MAL NUTRICIÓN POR EXCESO"%\'',
    'valor like \'%"tipo_atencion":"ESTADO NUTRICIONAL NORMAL"%\'',
];
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN L:  CLASIFICACIÓN DE CONSULTA NUTRICIONAL POR GRUPO DE EDAD (Incluidas en sección B) [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
