...
$FILTRO_PROFESION[0] = [
    'profesion like \'%MÉDICO%\' AND valor like \'%"INGRESO TRATAMIENTO"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"INGRESO QUIMIOPROFILAXIS"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"CONTROL MENSUAL"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"CONTROL DE SEGUIMIENTO"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"CONSULTAS ESPONTANEAS"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"RESCATE"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"CONTROL DE LOS CONTATOS"%\'',
    'profesion like \'%MÉDICO%\' AND valor like \'%"ATENCION DOMICILIARIA"%\'',
];
$PROFESIONES[1] = [
...
$FILTRO_PROFESION[1] = [
    'profesion like \'%ENFERMERA%\' AND valor like \'%"tipo_atencion":"INGRESO DE TRATAMIENTO"%\'',
    'profesion like \'%ENFERMERA%\' AND valor like \'%"tipo_atencion":"CONTROL MENSUAL"%\'',
    'profesion like \'%ENFERMERA%\' AND valor like \'%"tipo_atencion":"CONTROL DE SEGUIMIENTO"%\'',
    'profesion like \'%ENFERMERA%\' AND valor like \'%"tipo_atencion":"CONSULTAS ESPONTANEAS"%\'',
    'profesion like \'%ENFERMERA%\' AND valor like \'%"tipo_atencion":"RESCATE"%\'',
    'profesion like \'%ENFERMERA%\' AND valor like \'%"tipo_atencion":"ATENCION DOMICILIARIA"%\'',
];
...
<section id="seccion_A03A2" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN N:ATENCIONES AMBULATORIAS POR  EL PROGRAMA TUBERCULOSIS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
