...
$FILA_HEAD = [
    'Epuipo de espacio Amigable',
    'Otro Equipo de Salud',

];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Epuipo de espacio Amigable"%\'',
    'valor like \'%"tipo_atencion":"Otro Equipo de Salud"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN J: ATENCIÓN REMOTA ADOLESCENTE [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
