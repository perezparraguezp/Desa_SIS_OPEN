...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Método de Regulación de fertilidad"%\'',
    'valor like \'%"tipo_atencion":"Terapia Hormonal de la menopausia"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN Q: DESPACHO DE RECETAS DE SALUD SEXUAL Y REPRODUCTIVA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
    <table id="table_seccion_A5" style="width: 100%;border: solid 1px black;" border="1">
        ...
        <tr>
            ...
            <td>Despacho Extraordianrio</td>
            <td>En Establecimientos de Salud</td>
            <td>En Domicilio</td>
