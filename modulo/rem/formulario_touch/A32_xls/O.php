...
$FILA_HEAD = [
    ...
    'Contacto con familia fallidos',
    'Última sesión Termino de Tratramiento',

];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Intervenciones de seguimiento efectivas"%\'',
    'valor like \'%"tipo_atencion":"Intervenciones de otro tipo"%\'',
    'valor like \'%"tipo_atencion":"Contacto con familia fallidos"%\'',
    'valor like \'%"tipo_atencion":"Última sesión Termino de Tratramiento"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCION O: ATENCIONES REMOTAS EN MODALIDADES DE APOYO AL DESARROLLO INFANTIL (MADIS) EN APS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
