...
$FILA_HEAD_SQL = [
    ...
    'profesion like \'%Medicina General%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN B: CONSULTA MÉDICA EN ATENCIÓN PRIMARIA DE SALUD POR LLAMADA TELEFÓNICA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
