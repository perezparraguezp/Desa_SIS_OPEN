...
$FILA_HEAD = [
    'Pacientes',
    'Familiares/Cuidadores de los pacientes ',
    'Funcionarios',

];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Pacientes"%\'',
    'valor like \'%"tipo_atencion":"Familiares/Cuidadores de los pacientes"%\'',
    'valor like \'%"tipo_atencion":"Funcionarios"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCION K: ACCIONES REMOTAS DE MEDICINAS COMPLEMENTARIAS Y PRACTICAS DE BIENESTAR EN SALUD  [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
