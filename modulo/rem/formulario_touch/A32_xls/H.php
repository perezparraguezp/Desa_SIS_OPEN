...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Visita"%\'',
    'valor like \'%"tipo_atencion":"Procedimiento"%\'',
    'valor like \'%"tipo_atencion":"Llamada"%\'',
...
<section id="seccion_A03A5" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN H: ATENCIÓN DOMICILIARIA   [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
