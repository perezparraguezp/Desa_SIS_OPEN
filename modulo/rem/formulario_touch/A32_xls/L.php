...
$rango_seccion = [
    ...
    "registro_rem.edad like '%MENOR DE 1 AÑO%'",
...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Otras Consultas"%\'',
    'valor like \'%"tipo_atencion":"Malnutrición por Exceso"%\'',
    'valor like \'%"tipo_atencion":"Malnutrición por Déficit"%\'',
...
<section id="seccion_A03A2" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN L: ATENCIONES DE SEGUIMIENTO NUTRICIONAL VÍA REMOTA [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
