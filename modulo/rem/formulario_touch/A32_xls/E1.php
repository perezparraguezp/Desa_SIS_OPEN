...
$FILA_HEAD_SQL = [
    ...
    'valor like \'%"tipo_atencion":"Mensajería de Texto"%\'',
    ...
    <div class="row">
        <div class="col l10">
            <header>SECCION E: ACCIONES DE SALUD MENTAL REMOTAS EN CONTEXTO DE EMERGENCIA SANITARIA
                <BR />SECCIÓN E1: ACCIONES TELEFÓNICAS DE SALUD MENTAL (APS Y ESPECIALIDAD) [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
