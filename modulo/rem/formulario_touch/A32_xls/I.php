...
$FILA_HEAD = [
    ...
    'Video llamadas',
    'Contacto individual  por mensaje en redes sociales',
    'Contacto grupal por mensaje en redes sociales',


];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_atencion":"Llamadas telefónicas"%\'',
    'valor like \'%"tipo_atencion":"Video llamadas"%\'',
    'valor like \'%"tipo_atencion":"Contacto individual  por mensaje en redes sociales"%\'',
    'valor like \'%"tipo_atencion":"Contacto grupal por mensaje en redes sociales"%\'',
];
...
<section id="seccion_A03A2" style="width: 100%;overflow-y: scroll;">
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN I: ACTIVIDADES DE ACOMPAÑAMIENTO REMOTO A PERSONAS MAYORES Y SUS FAMILIAS POR PARTE DEL PROGRAMA MÁS ADULTOS MAYORES AUTOVALENTES [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
