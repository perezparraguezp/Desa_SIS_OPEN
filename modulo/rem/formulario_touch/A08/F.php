    ...
    <div class="row">
        <div class="col l12">
            <div class="container" id="info_evaluacion">
                <div class="row">
                    <div class="col l4">TIPO DE PACIENTES</div>
                    <div class="col l8">
                        <select name="tipo_atencion" id="tipo_atencion">
                            <option>PACIENTES FALLECIDOS EN ESPERA DE ATENCIÓN MÉDICA</option>
                            <option>PACIENTES FALLECIDOS EN PROCESO DE ATENCIÓN</option>
                            <option>PACIENTES FALLECIDOS EN ESPERA DE CAMA HOSPITALARIA</option>
                        </select>
                        <script type="text/javascript">
                            $(function(){
