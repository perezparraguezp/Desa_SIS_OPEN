...
$FILA_HEAD = [
    'NÚMERO DE PERSONAS CON AYUDA TÉCNICA ENTREGADA',


];
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_Actividad":"NÚMERO DE PERSONAS CON AYUDA TÉCNICA ENTREGADA"%\'',
    ...
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN C: AYUDAS TÉCNICAS DE SALUD, NIVEL APS Y HOSPITALARIO
                <BR/>SECCIÓN C.1: NÚMERO DE PERSONAS QUE RECIBEN AYUDAS TÉCNICAS [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
