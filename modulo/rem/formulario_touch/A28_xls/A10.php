...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_Actividad":"NÚMERO DE PERSONAS"%\'',
    'valor like \'%"tipo_Actividad":"NÙMERO DE SESIONES"%\'',
    ...
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN A:  NIVEL PRIMARIO
                <BR />SECCIÓN A.10: INTERVENCIONES TERAPÉUTICAS GRUPALES  [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
