...
$FILA_HEAD_SQL = [
    'valor like \'%"tipo_Actividad":"VISITA DOMICILIARIA INTEGRAL"%\'',
    'valor like \'%"tipo_Actividad":"VISITA DE TRATAMIENTO Y/O PROCEDIMIENTO"%\'',
    ...
    <div class="row">
        <div class="col l10">
            <header>SECCIÓN A:  NIVEL PRIMARIO
                <BR />SECCIÓN A.9: VISITAS DOMICILIARIAS INTEGRALES [<?php echo fechaNormal($fecha_inicio).' al '.fechaNormal($fecha_termino) ?>]</header>
        </div>
    </div>
