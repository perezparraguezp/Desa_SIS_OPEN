                ...
                <div class="col l12 m12 s12">
                    <div class="card-panel eh-open_fondo">
                        <div class="row">
                            ...
                            <div class="col l2 center-align">
                                <i class="mdi-editor-insert-chart"
                                   onclick="loadHistorialParametroAM('<?php echo $rut ?>','actividad_fisica')"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col l12 m12 s12">
                    <div class="card-panel eh-open_fondo">
                        <div class="row">
                            <div class="col l3 m6 s12">
                                <strong style="line-height: 2em;font-size: 1.5em;">TIMED UP AND GO <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="EL REGISTRO SERÁ GUARDADO AUTOMATICAMENTE">(?)</strong></strong>
                            </div>
                            <div class="col l7 m6 s12">
                                <div class="row">
            ...
            <div class="row">
                <div class="col l12 m12 s12">
                    <div class="card-panel eh-open_fondo">
                        <div class="row">
                            <div class="col l3 m6 s12">
                                <strong style="line-height: 2em;font-size: 1.5em;">ESTACION UNIPODAL <strong class="tooltipped" style="cursor: help" data-position="bottom" data-delay="50" data-tooltip="EL REGISTRO SERÁ GUARDADO AUTOMATICAMENTE">(?)</strong></strong>
                            </div>
                            <div class="col l7 m6 s12">
                                <div class="row">
                                    <select class="browser-default"
                ...
                <div class="col l12 m12 s12">
                    <div class="card-panel eh-open_fondo">
                        <div class="row">
                            ...
                            <div class="col l2 center-align">
                                <i class="mdi-editor-insert-chart"
                                   onclick="loadHistorialParametroAM('<?php echo $rut ?>','sospecha_maltrato')"></i>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col l12 m12 s12">
                    <div class="card-panel eh-open_fondo">
                        <div class="row">
                            ...
                            <div class="col l2 center-align">
                                <i class="mdi-editor-insert-chart"
                                   onclick="loadHistorialParametroAM('<?php echo $rut ?>','yesavage')"></i>
                            </div>
                        </div>
                    </div>
                </div>
