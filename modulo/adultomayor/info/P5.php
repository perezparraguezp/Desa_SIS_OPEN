...
<script type="text/javascript">
    ...
    function loadP5_adultomayor() {
        var id = $("#centro_interno").val();
        var div = 'tabla_P5';
        loading_div(div);
        $.post('info/tabla_p5.php',{
            id:id
        },function(data){
            if(data !=='ERROR_SQL' ){
                $("#"+div).html(data);
...
<form action="https://www.sis-open.com/exportar/table.php"  method="post" target="_blank" id="formExport">
