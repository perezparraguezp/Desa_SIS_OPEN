...
if($comunal==true){
    ...
    $sql_0 = "select *  from persona 
                                    ...
                                    where m_adulto_mayor='SI'
                                      AND chile_cuida='SI' and persona.edad_total_dias>=65*12
    ...
    while ($row_0 = mysql_fetch_array($res_0)){
        ...
        if($row_1){
            $sql_2 = "select * from historial_parametros_am 
                                          where rut='$persona->rut' and indicador='chile_cuida'
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        var setting = {
            title: 'CHILE CUIDA - VALOR: <?php echo $atributo; ?>',
        ...
        $("#table_grid").jqxGrid(
            {
                ...
                columns: [
                    ...
                    { text: 'CHILE CUIDA', dataField: 'CHILE_CUIDA', cellsalign: 'center', width: 150,filtertype: 'checkedlist'},
