...
function limpiaCadena($cadena) {
    $cadena = (ereg_replace('[^ A-Za-z0-9_-ñÑ]', '', str_replace("Ñ","N",str_replace("ñ","n",trim($cadena)))));
    $cadena = (ereg_replace('[^ A-Za-z0-9]', '', trim($cadena)));
    return trim($cadena);
}
...
function enviarMail($para,$asunto,$mensaje,$reply,$remitente,$titulo){
    $reply_to = 'eh@eh-open.com';
...
<h1 style="color:#555555;direction:ltr;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;font-size:23px;font-weight:normal;line-height:120%;text-align:center;margin-top:0;margin-bottom:0;">'.$titulo.'</h1>
</td>
</tr>
</table>
<!--[if (!mso)&(!IE)]><!-->
...
<p style="font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin: 0;">'.$mensaje.'</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<div align="left" class="img-container left autowidth" style="padding-right: 15px;padding-left: 15px;">
...
<div style="font-size:1px;line-height:15px"> </div><a href="https://eh-open.com/" style="outline:none" tabindex="-1" target="_blank"><img border="0" class="left autowidth" src="http://200.68.17.244/ehopen/images/Logo_ehopen.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 500px; display: block;" width="500"/></a>
