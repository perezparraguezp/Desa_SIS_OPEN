...
$titulo_documento = "<h4>CERTIFICADO<br />ORGANIZACION COMUNITARIA<br />Nº 451</h4>";
...
if($row3['hasta']>=date('Y-m-d')){
    $vigencia = "<strong>VIGENTE HASTA:</strong> ".fechaNormal($row3['hasta']);
}else{
    $vigencia = "<strong>EXPIRADA CON FECHA:</strong> ".fechaNormal($row3['hasta']);
}
...
<p style="text-align: right;">451 / '.date('Y').'</p>
'.$titulo_documento.'
<h6>PERSONALIDAD JURIDICA</h6>
<table style="width:100%;font-size:0.8em;">
    <tr>
        <td colspan="2" style="text-align:right">Fecha Emisión: 27/08/2019</td>
    </tr>
    <tr>
...
<br /><br />
<p>Este certificado es valido hasta el dia '.trim($valido_hasta).'</p>
<p></p>
<p></p>
<p></p>
<p></p>
