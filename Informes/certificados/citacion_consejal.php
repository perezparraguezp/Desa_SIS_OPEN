...
$firmante_citacion =$_POST['citacion'];
$cargo_citador =$_POST['cargo_citador'];

$firmante_citacion = $firmante_citacion.'<br />'.$cargo_citador;
...
if($tipo_reunion=='Ordinaria'){
    $lista_temas_reunion.='<li>Correspondencia Recibida y Despachada</li>
...
<table>
    <tr>
        <td></td>
        <td style="text-align:center"><h5><strong>'.strtoupper($firmante_citacion).'</strong></h5></td>
    </tr>
</table>';
...
while($row2 = mysql_fetch_array($res2)){
    ...
    <table>
        <tr>
            ...
            <td></td>
            <td style="text-align:center"><h5 style="font-size: 1em;"> <strong>'.strtoupper($firmante_citacion).'</strong></h5></td>
        </tr>
    </table>
    <p></p>
    <table >
...
$html_concejal = '
    ...
    <table>
        <tr>
            ...
            <td></td>
            <td style="text-align:center"><h6 style="font-size: 1em;"><strong>'.strtoupper($firmante_citacion).'</strong></h6></td>
        </tr>
    </table>
    <p></p>
    <table>
