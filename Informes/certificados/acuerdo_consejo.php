...
//Eliminamos los textos del documento
 ...
 $texto2 = str_replace('â€‹','', $_POST['textarea_acuerdo']);
...
$tema_acuerdo = $row1['numero_acuerdo'];//numero_acuerdo
...
if($acuerdo == ''){
    ...
    $sql12 = "SELECT *
              ...
              desc limit 1 ";
    $rows1 = mysql_fetch_array(mysql_query($sql12));

    $numero_acuerdo = $rows1['numero_acuerdo']+1;
    //echo "Acuerdo ".$acuerdo;
...
<P></P>
<h1>CERTIFICADO Nº'.$numero_certificado.'</h1>
